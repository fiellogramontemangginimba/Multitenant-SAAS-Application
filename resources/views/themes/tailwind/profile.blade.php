...
@section('content')
	...
	<div class="flex flex-col px-8 mx-auto my-6 xl:px-5 lg:flex-row max-w-7xl">
		...
		<div class="flex flex-col w-full p-10 overflow-hidden bg-white border rounded-lg lg:w-2/3 border-gray-150 lg:flex-2">
			<p class="text-lg text-gray-600">Hello {{ $user->name }}, we wanted to let you know that your order is on its way! Our delivery team is currently en route to your location and should arrive in approximately 3:30 pm today. We hope you enjoy your meal and thank you for choosing Foodies Restaurant for your delivery needs. If you have any questions or concerns about your order, please don't hesitate to contact us. Thank you again and have a great day!</p>
